...
I'm a full-stack developer with a BSc in Computer Science from the **University of Tartu**.
I work as a full-stack developer, primarily using Kotlin, Java, Angular, and PostgreSQL, with additional experience in Python, React, SQLite, Rust, and C++.
...
- In my free time, I enjoy working with FPV drones and experimenting with microcontrollers. I recently participated in a engineering competition **Enginaator** where me and my team reached the finals. You can check out the [pre-finals project](https://github.com/kert114/tenny) and the [finals project](https://github.com/Spoldma/2d-printer).
...
🔭 My BSc thesis can be found here [here](https://hdl.handle.net/10062/116944).
